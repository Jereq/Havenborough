copy ..\Sound\Bin\Sound.dll Bin\
copy ..\Graphics\Bin\Graphics.dll Bin\
copy ..\Network\Bin\Network.dll Bin\
copy ..\Physics\Bin\Physics.dll Bin\
copy ..\Server\Bin\Server.exe Bin\
copy "C:\Program Files (x86)\Microsoft Visual Studio 11.0\VC\redist\x86\Microsoft.VC110.CRT\msvcr110.dll" Bin\
